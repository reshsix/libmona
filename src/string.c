...
Libmona is free software: you can redistribute it and/or modify it
...
along with libmona. If not, see <https://www.gnu.org/licenses/>.
*/
...
extern const char *
mona_string(uint8_t value, enum mona_string type)
{
    char *ret = NULL;
